...
* [OAuth2 Client](https://docs.spring.io/spring-boot/4.0.2/reference/web/spring-security.html#web.security.oauth2.utilisateur)
...
* [HTTP Client](https://docs.spring.io/spring-boot/4.0.2/reference/io/rest-utilisateur.html#io.rest-utilisateur.restclient)
